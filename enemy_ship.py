...
class EnemyShip(Ship):
    def __init__(self, player, screen, x, y,speed, WIDTH, HEIGHT, bullet_group, theta=270, color='gray'):
        super().__init__(screen, x, y,speed, WIDTH, HEIGHT, bullet_group, theta, color)
        self.player = player
